...
export default function About() {
  ...
  return (
    <section className="relative h-[90vh] flex justify-center">
      ...
      ></div>
      <div className="relative z-10 w-full h-full text-white p-6 pt-12 pb-12 flex flex-col items-start justify-around">
        <div>
          <h1
